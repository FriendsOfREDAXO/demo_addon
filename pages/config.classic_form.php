...
$formElements = [];
$n = [];
$n['label'] = '<label for="demo_addon-config-text">' . $this->i18n('config_text') . '</label>';
...
$formElements = [];
$n = [];
$n['label'] = '<label for="demo_addon-config-select">' . $this->i18n('config_select') . '</label>';
...
/* FIX für Multiselect da rex_config_form in Pipe-Schreibweise speichert */
if (!is_array($mselect)) {
...
$n['field'] = $select->get();
$n['field'] .= $this->i18n('config_multiselect_note');
$formElements[] = $n;
...
$formElements = [];
$n = [];
$n['label'] = '<label for="demo_addon-config-radio1">' . $this->i18n('demo_addon_config_radio_fe') . '</label>';
...
$n = [];
$n['label'] = '<label for="demo_addon-config-radio2">' . $this->i18n('demo_addon_config_radio_be') . '</label>';
...
$formElements = [];
$n = [];
$n['label'] = '<label for="REX_MEDIALIST_SELECT_1">' . $this->i18n('config_files') . '</label>';
...
$formElements = [];
$n = [];
$n['label'] = '<label for="REX_LINKLIST_SELECT_1">' . $this->i18n('config_articles') . '</label>';
...
$fragment->setVar('title', $this->i18n('config_title_classic'));
